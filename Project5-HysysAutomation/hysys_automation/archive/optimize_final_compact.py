...
# Estimated Optimal Pressures (Starting Points)
PRESET_P = {
    500: 3.0, 
    600: 3.5, 
    700: 4.1, 
...
class HysysEngine:
    ...
    def set_inputs_safe(self, flow, p_bar, t_deg):
        try:
            ...
            time.sleep(1.5) # Anti-Lag Buffer
...
def optimize(eng, flow):
    ...
    # Narrow pressure scan for speed: Center +/- 0.2 bar
...
if __name__ == "__main__":
    ...
    with open(os.path.join(FOLDER, OUT_FILE), 'w', newline='') as csvf:
        ...
        writer.writerow(["MassFlow", "P_bar", "T_C", "MinApp_C", "Power_kW"])
